  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["fortmatic"], {
    ...
    function n8m1(module, exports) {
      module.exports = function (e) {
        ...
        function l(e, t) {
          ...
          !function (e) {
            var t,
                ...
                i,
                a,
                s = !!e.data.response.error || !!e.data.response.message || !!e.data.response.code,
                u = {
                  ...
                  case 1:
                    return r = o.sent(), [2, new Promise(function (e, o) {
                      if (r.contentWindow) {
                        ...
                        var f = i.on(a.FmIncomingWindowMessage.FORTMATIC_HANDLE_RESPONSE, (h = function h() {
                          f(), y();
                        }, function (t) {
                          var r = l(n, t),
                              o = r.id,
                          ...
                          return function (r) {
                            ...
                            if (i && s.isJsonRpcBatchRequestPayload(n) && p.includes(i)) {
                              ...
                              for (var y = d.length; y < n.batch.length; y++) {
                                d.push(new u.JsonRpcResponse(n.batch[y]).applyError(c).payload);
                              }
        ...
        }(t.FmIncomingWindowMessage || (t.FmIncomingWindowMessage = {})), function (e) {
        ...
        }(t.SDKErrorCode || (t.SDKErrorCode = {})), function (e) {
          e.SyncWeb3Method = "SYNC_WEB3_METHOD", e.DuplicateIframe = "DUPLICATE_IFRAME";
        }(t.SDKWarningCode || (t.SDKWarningCode = {})), function (e) {
        ...
        var _r5,
            o = this && this.__extends || (_r5 = function r(e, t) {
          ...
          return Object.defineProperty(e.prototype, "overlayReady", {
            ...
            return new Promise(function (t) {
              var n = function n() {
                ...
                }))) c.createDuplicateIframeWarning().log();else {
                  var n = document.createElement("iframe");
                  n.classList.add("fortmatic-iframe"), n.dataset.fortmaticIframeLabel = new URL(e.endpoint).host, n.src = new URL("/send?params=" + e.encodedQueryParams, e.endpoint).href, function (e) {
                    var t, n;
