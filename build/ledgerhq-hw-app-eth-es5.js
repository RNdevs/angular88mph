          ...
          _createClass(Eth, [{
            ...
            value: function signTransaction(path, rawTxHex) {
              ...
              if (rlpTx.length > 6) {
                ...
                var chainIdSrc = rlpTx[6];
                var chainIdBuf = Buffer.alloc(4);
            ...
            * @example
            ...
            key: "starkSignTransfer_v2",
            value: function starkSignTransfer_v2(path, transferTokenAddress, transferQuantizationType, transferQuantization, transferMintableBlobOrTokenId, targetPublicKey, sourceVault, destinationVault, amountTransfer, nonce, timestamp, conditionalTransferAddress, conditionalTransferFact) {
              var transferTokenAddressHex = maybeHexBuffer(transferTokenAddress);
              var targetPublicKeyHex = hexBuffer(targetPublicKey);
            ...
            key: "starkProvideQuantum_v2",
            value: function starkProvideQuantum_v2(operationContract, operationQuantizationType, operationQuantization, operationMintableBlobOrTokenId) {
              var operationContractHex = maybeHexBuffer(operationContract);
            ...
            key: "starkUnsafeSign",
            value: function starkUnsafeSign(path, hash) {
            ...
            key: "eth2GetPublicKey",
            value: function eth2GetPublicKey(path, boolDisplay) {
              var paths = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["splitPath"])(path);
              var buffer = Buffer.alloc(1 + paths.length * 4);
              buffer[0] = paths.length;
              paths.forEach(function (element, index) {
            ...
            key: "eth2SetWithdrawalIndex",
            value: function eth2SetWithdrawalIndex(withdrawalIndex) {
